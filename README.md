...
<div align="justify"><em>Saliency maps vs. ground truth.</em> Given several original images (top), our saliency detection method is used to generate saliency maps by measuring regional principal color contrasts (middle), which are comparable to manually labeled ground truth (bottom).</div>
...
These resources are also available at [Baidu Cloud (百度网盘)](http://pan.baidu.com/disk/home#list/vmode=list&path=%2Fresearch%2Fp2014-rpc-saliency).
